...
from networks.Networks import japaness_generator, japaness_discriminator
from dataset.CustomDataLoader import CustomDataLoader, Custom_real_DataLoader
...
##### HYPER PARAMETERS (TODO) ###########################################################################
root_fmri =
root_image =
self_ROI_array =
nsd_subj01_08_id_img =
fmri_dim =
################################################################################
n_epochs = 10
display_step = 1
...
noise_shape = (height, 4, 4)  #NOTE: (256,4,4)
################################################################################
...
# dataset
dataset = CustomDataLoader(root_fmri, root_image, self_ROI_array, nsd_subj01_08_id_img, transform=trans)

# dataloader
dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=True, drop_last=True)

gen = japaness_generator(fmri_dim, noise_shape).to(device)
gen_opt = torch.optim.Adam(gen.parameters(), lr=lr, betas=(beta_1, beta_2))
crit = japaness_discriminator().to(device)
